//
//  Using Files - Numeric Processing.cpp
//  CPP Course
//
...
// MARK: - Task
/*
 Download the Random.txt file. This file contains a long list of random numbers. Copy the file to your hard drive and then write a program that opens the file, reads all the numbers from the file, and calculates and displays the following:
 */
