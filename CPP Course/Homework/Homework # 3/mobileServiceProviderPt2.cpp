...
// This program is used to show a user how much their minthly charge is, and how much they would save
// with other plans.
...
//    // Variables
//    char userChoice;
//    float numberOfMinutes, totalChargesA, totalChargesB, couldHaveSavedOne, couldHaveSavedTwo;
//
...
//        case 'a':
//
//            // Calculate the total charges for a, b, and c.
//            totalChargesA =
...
//            : PACKAGE_B;
//            
//            // Calculate what the user could have saved
//            couldHaveSavedOne = totalChargesA - totalChargesB;
//            couldHaveSavedTwo = totalChargesA - PACKAGE_C;
//
//            // Message part two.
//            cout << "$" << totalChargesA  << " dollars." << endl;;
//            
//            
//            
//            if (totalChargesA > totalChargesB) {
//                
//                cout << "You could have saved $"<< couldHaveSavedOne << " with Package B." << endl;
//                
//                cout << "You could have saved $"<< couldHaveSavedTwo << " with Package C." << endl;
//
//            }
//
//            break;
...
//
//            // Calculate what the user could have saved
//            couldHaveSavedTwo = totalChargesB - PACKAGE_C;
//            
//            // Message part two.
